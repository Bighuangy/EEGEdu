  ...
  <div class="card">
    ...
    <div class="card-section">
      <div class="range-slider">
        <label>Epoch duration: {{ localSettings.duration }}</label>
      ...
      <div class="range-slider">
        <label>Interval: {{ localSettings.interval }}</label>
      ...
      <div class="range-slider">
        <label>Cutoff Low: {{ localSettings.cutOffLow }} Hz</label>
      ...
      <div class="range-slider">
        <label>Cutoff High: {{ localSettings.cutOffHigh }} Hz</label>
      ...
      <div class="range-slider">
        <label>Slice FFT Low: {{ localSettings.sliceFFTLow }} Hz</label>
      ...
      <div class="range-slider">
        <label>Slice FFT High: {{ localSettings.sliceFFTHigh }} Hz</label>
