  ...
  <div class="card">
    ...
    <div class="card-section">
      <div class="range-slider">
        ...
        <input type="range" :min="1" :max="4096" :step="1" v-model.number="localSettings.duration" :disabled="status === 'Connect'" @change="updateSettings" />
      </div>
      <div class="range-slider">
        <label>Sampling points between epochs onsets: {{ localSettings.interval }}</label>
        <input type="range" :min="1" :max="localSettings.duration" :step="1" v-model.number="localSettings.interval" :disabled="status === 'Connect'" @change="updateSettings" />
      </div>
      <div class="range-slider">
